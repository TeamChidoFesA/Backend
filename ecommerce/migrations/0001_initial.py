# Generated by Django 2.0.1 on 2018-02-12 23:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.Cat_status_order')),
                ('tipo_pago', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.Cat_type_pay')),
            ],
            options={
                'db_table': 'Order',
            },
